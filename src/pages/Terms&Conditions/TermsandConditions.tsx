      ...
      <Grow in={animate} timeout={1000}>
        <Box maxWidth={1300} margin={"auto"}>
          ...
          >
            ...
            Welcome to COMMERCE UI ("we," "us," "our"). By accessing or using
            our Shopify services, you agree to be bound by these Terms and
            Conditions. Please read them carefully before engaging our services.
            <br />
            <br />
            <strong>2. Scope of Services</strong> <br />
            We specialize in providing Shopify-related services, including but
            not limited to:
            <ul>
            ...
            <ul>
              ...
              <li>
                You have the authority to enter into these Terms and Conditions
            ...
            <ul>
              <li>
                All services are billed as agreed upon in the project proposal
                or invoice.
              </li>
              <li>
            ...
            disclose it to third parties without prior consent, except as
            required by law.
            <br />
            <br />
            ...
            <ul>
              <li>
                We are not responsible for any loss or damage arising from the
                use or inability to use the Shopify platform or third-party
                tools.
              </li>
              <li>
            ...
            <ul>
              <li>
                Minor revisions are included as specified in the proposal.
              </li>
              <li>
